...
$pageQry = mysqli_query($server, "SELECT * FROM login") or die ("error paging: ".mysql_error($server));
...
<?php
	if(@$_POST['user']){
			include_once("../library/koneksi.php");
			mysqli_query($server,"insert into login set username='".$_POST["usr"]."', password='".$_POST["pas"]."', nama='".$_POST["nma"]."', alamat='".$_POST["alt"]."'");
...
<div class="panel panel-default">
	...
	<div class="panel-body">
		<div class="table-responsive">
			...
			<?php
				$usQry = mysqli_query($server, "SELECT * FROM login ORDER BY kd_user DESC LIMIT $hal, $row")  or die ("Query Obat salah : ".mysql_error($server));
				$nomor  = 0; 
				$nomor++;
